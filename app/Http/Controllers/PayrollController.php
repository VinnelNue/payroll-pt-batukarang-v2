...
class PayrollController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        // Ambil karyawan aktif beserta data payroll periode terpilih (jika sudah pernah disimpan)
    ...
    // Import Rekap Absensi dari File Excel (Payroll V2)
    ...
    public function store(Request $request)
    {
        ...
        foreach ($request->payrolls as $empId => $data) {
            ...
            // Helper untuk membersihkan format ribuan Indonesia (contoh: "1.500.000" -> 1500000)
            ...
            // 3. Kalkulasi Potongan Unpaid Leave (Pro-rata Hari Kerja, acuan 27 hari)
            ...
            // 4. Kalkulasi Gaji Bruto (Pendapatan Kotor)
            $overtimePay = $overtimeHours * 20000; // Standar Rp 20.000/jam
            $grossSalary = $netBasicSalary + $netAllowance + $overtimePay + $maternityLeavePay + $incentive;

            // 5. Kalkulasi Potongan BPJS Dinamis dari Database
...
// Halaman Master Acuan PPh 21 TER & BPJS
    public function taxBpjsMaster()
    {
        // Ambil Setting BPJS dari Database
        $bpjsSettings = [
        ...
        // Acuan Tarif TER PPh 21 (PP 58/2023) - Read Only / Statis Hukum
        $terCategories = [
            'TER_A' => [
                'ptkp' => 'TK/0, TK/1, K/0',
    ...
    // Update Setting BPJS oleh Finance/HRD
