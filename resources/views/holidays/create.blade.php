...
@section('page_title', 'Tambah Hari Libur')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                Tambahkan hari besar atau hari libur yang akan digunakan dalam perhitungan payroll.
            </p>
        </div>
            ...
            <form method="POST"
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-text">
                            Pilih tanggal yang ditetapkan sebagai hari libur.
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="type"
                            ...
                            <option value="collective_leave"
                                {{ old('type') === 'collective_leave' ? 'selected' : '' }}>
                                Cuti Bersama
                            </option>
                ...
                <div class="alert alert-info mt-4 mb-0">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <div>
                            ...
                            <div class="small">
                                Hari libur aktif akan menjadi default
                                <strong>HB</strong> pada tanggal tersebut.
                                Jika karyawan memiliki absensi eksplisit seperti
                                <strong>H</strong>, status absensi tersebut tetap
                                digunakan.
                            </div>
