...
<div class="mb-4 d-flex justify-content-between align-items-center">
    ...
    <a href="{{ route('employees.local.index') }}" class="btn btn-outline-secondary btn-sm px-3 py-2 rounded-3">
        <i class="fa-solid fa-arrow-left me-1"></i> Kembali
    </a>
</div>

<form action="{{ route('employees.local.update', $employee->uuid) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')

    @include('employees.local._form')

    <div class="col-12 text-end my-4">
        <a href="{{ route('employees.local.index') }}" class="btn btn-light border px-4 me-2">Batal</a>
